...
namespace ILRuntime.Runtime.Generated
{
    unsafe class libx_Assets_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(libx.AssetRequest)};
        ...
        static StackObject* UnloadAsset_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            libx.AssetRequest @asset = (libx.AssetRequest)typeof(libx.AssetRequest).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

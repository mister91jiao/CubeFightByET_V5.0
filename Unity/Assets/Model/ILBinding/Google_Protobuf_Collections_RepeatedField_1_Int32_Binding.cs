...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_Int32_Binding
    {
        ...
        {
            return ((Google.Protobuf.Collections.RepeatedField<System.Int32>)o).array;
        }

        static StackObject* CopyToStack_array_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((Google.Protobuf.Collections.RepeatedField<System.Int32>)o).array;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_array_0(ref object o, object v)
        {
            ((Google.Protobuf.Collections.RepeatedField<System.Int32>)o).array = (System.Int32[])v;
        }
        ...
        static StackObject* AssignFromStack_array_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((Google.Protobuf.Collections.RepeatedField<System.Int32>)o).array = @array;

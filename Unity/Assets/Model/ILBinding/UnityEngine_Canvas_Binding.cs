...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Canvas_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_worldCamera_1);
            args = new Type[]{};
            method = type.GetMethod("get_scaleFactor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_scaleFactor_2);
            args = new Type[]{typeof(UnityEngine.Camera)};
            method = type.GetMethod("set_worldCamera", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_worldCamera_3);
        ...
        static StackObject* get_worldCamera_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_scaleFactor_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_worldCamera_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;

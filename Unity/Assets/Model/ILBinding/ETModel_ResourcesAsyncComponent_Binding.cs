...
{
    unsafe class ETModel_ResourcesAsyncComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ResourcesAsyncComponent);
            args = new Type[]{typeof(libx.SceneAssetRequest)};
            ...
            if (genericMethods.TryGetValue("LoadAssetAsync", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(ETModel.ETTask<UnityEngine.GameObject>), typeof(libx.AssetRequest)))
                    {
        ...
        static StackObject* LoadAssetAsync_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            libx.AssetRequest @assetRequest = (libx.AssetRequest)typeof(libx.AssetRequest).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = instance_of_this_method.LoadAssetAsync<UnityEngine.GameObject>(@assetRequest);

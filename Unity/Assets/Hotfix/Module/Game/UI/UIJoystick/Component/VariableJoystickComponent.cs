...
namespace ETHotfix
{
    ...
    public class VariableJoystickComponent : Component
    {
        ...
        public void Start()
        {
            ...
            //获取组件引用
            background = rc.Get<GameObject>("Background").GetComponent<RectTransform>();
            handle = rc.Get<GameObject>("Handle").GetComponent<RectTransform>();
            baseRect = rc.Get<GameObject>("Joystick").GetComponent<RectTransform>();

            //获取canvas引用
            canvas = rc.Get<GameObject>("UIJoystick").GetComponent<Canvas>();

            if (canvas == null)
                Debug.LogError("The Joystick is not placed inside a canvas");
                    
            HandlerAgent handlerAgent = baseRect.gameObject.AddComponent<HandlerAgent>();
            handlerAgent.Init(OnPointerDown, OnDrag, OnPointerUp);
